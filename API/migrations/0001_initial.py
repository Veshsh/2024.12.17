...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('history', models.FileField(auto_created=True, editable=False, upload_to='')),
                ('log', models.FileField(auto_created=True, editable=False, upload_to='')),
                ('time_save', models.DateTimeField(auto_now_add=True)),
                ('machin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='API.machin')),
            ],
        ),
        migrations.CreateModel(
            name='Machin_Group',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True)),
                ('machin', models.ManyToManyField(related_name='machin_group', to='API.machin')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('login', models.CharField(blank=True, max_length=150, unique=True, verbose_name='login')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('machin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='API.machin')),
                ('machin_group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='API.machin_group')),
